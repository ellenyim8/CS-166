...
public class EmbeddedSQL {
   ...
   public static void Query2(EmbeddedSQL esql){
      // Your code goes here.
      try { 
      	String query = "SELECT S.SNAME, COUNT(*) FROM SUPPLIERS S, PARTS P, CATALOG C WHERE S.SID=C.SID AND P.PID=C.PID GROUP BY S.SID HAVING COUNT(*) >= 3;";
        int rowCount = esql.executeQuery(query);
        System.out.println("total row(s): " + rowCount);
      } catch(Exception e) {
      	System.err.println(e.getMessage());
   ...
   public static void Query3(EmbeddedSQL esql){
      // Your code goes here.
      try {
      	String query = "SELECT S.SNAME, COUNT(*) FROM SUPPLIERS S, PARTS P, CATALOG C WHERE S.SID=C.SID AND P.PID=C.PID AND S.SID IN (SELECT S.SID FROM SUPPLIERS S, PARTS P, CATALOG C WHERE S.SID=C.SID AND P.PID=C.PID AND P.COLOR='Green') GROUP BY S.SID;";
        int rowCount = esql.executeQuery(query);
        System.out.println("total row(s): " + rowCount);
	} catch (Exception e) { 
		System.err.println(e.getMessage());
